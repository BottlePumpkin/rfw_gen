...
@RfwWidget('root')
Widget buildWidgetDetailConditional() {
  return SingleChildScrollView(
    child: Column(
      ...
      children: [
        ...
        SizedBox(height: 8.0),
        Text(
          'Renders one of two children based on a boolean condition.',
        ...
        ConditionalWidget(
          condition: true,
          childIfTrue: Text('Condition is true'),
          childIfFalse: Text('Condition is false'),
        ),
        SizedBox(height: 32.0),
        Text(
          'Properties',
        ...
        DocTable(
          ...
          rows: [
            ['condition', 'bool', 'Yes'],
            ['childIfTrue', 'Widget', 'Yes'],
            ['childIfFalse', 'Widget', 'Yes'],
          ],
        ),
        SizedBox(height: 32.0),
        Text(
